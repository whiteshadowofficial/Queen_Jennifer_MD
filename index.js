...
⭐✑ I'm Not Sure If It Was A Goodbye Charm, But It Was Fun While It Lasted 😌✨` })
    ...
    GojoMdNx.ev.on('connection.update', async (update) => {
        ...
        if (connection === 'close') {
            ...
            if (reason === DisconnectReason.badSession) { print(`Bad Session File, Please Delete Session and Scan Again`); GojoMdNx.logout(); }
            ...
            else if (reason === DisconnectReason.connectionReplaced) { print("🐦Connection Replaced, Another New Session Opened, Please Close Current Session First"); GojoMdNx.logout(); }
            else if (reason === DisconnectReason.loggedOut) { print(`🐦Device Logged Out, Please Scan Again And Run.`); GojoMdNx.logout(); }
